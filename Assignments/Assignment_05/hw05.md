...
new.gr <- gapminder %>%
            ggplot(aes(x = gdpPercap, 
              ...
              labs( x = "GDP per capita, ($ US, inflation-adjusted)", #make nice x axis label
                    ...
                    title = "Life expectancy increases associated with rising GDP show diminishing returns",
...
### A comparison of the two graphs:
 ...
 - In my original graph, Iwanted to use solid filled points but I couldn't because there was too much overlap. I didn't really like how the circle markers looked. In the new graph, the use of the _alpha_ argument allowed points to not overshadow eachother as much.
...
### Things I did differently in the new graph:
 ...
 - I changed the figure title so that it better reflects what I am trying to show.
...
### Things I thought about doing differently in the new graph but chose not to:
 ...
 - I considered to turn off the x axis limits, but most of the points past $50000 are a distraction to the question I am seeking to answer. There are just a few points, mostly for Kuwait, where there is high income and low life expectancy.
